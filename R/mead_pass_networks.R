...
ggsave(
  here::here("plots/passes_mead_base.png"),
  base_plot, width = 20, height = 12, units = "in", dpi = 300)

# Import base plot and add titles ----------------------------------------------

# Import map image
base_img <- magick::image_read(here::here("plots/passes_mead_base.png")) |>
...
plot_with_titles <- ggplot() +
  ...
  labs(
    title = "Completed passes to & from Beth Mead",
...
ggsave(
  here::here("plots/passes_mead_base_with_titles.png"),
...
plot_with_logo <- add_logo(
  plot_path = here::here("plots/passes_mead_base_with_titles.png"), # url or local file for the plot
...
magick::image_write(
  plot_with_logo, here::here("plots/passes_mead_with_logo.png"))

# Add player headshot ----------------------------------------------------------

plot_with_headshot <- add_logo(
  plot_path = here::here("plots/passes_mead_with_logo.png"), # url or local file for the plot
  logo_path = here::here("img/250023778.jpg"), # url or local file for the logo
...
# save the image and write to working directory
magick::image_write(
  plot_with_headshot, here::here("plots/passes_mead_combined.png"))
